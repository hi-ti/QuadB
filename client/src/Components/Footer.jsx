...
const Footer = () => {
	return (
		<footer
			id="footer"
			className="w-full px-8 py-8 gap-[32px] bg-gray-800 flex justify-center items-center"
		>
			<img
				className="hidden lg:flex w-[100%] sm:w-[55%] md:w-[25%]"
				src={FootImg}
				alt="winter is comming"
				width="25%"
			/>

			<div className="w-[100%] lg:w-[60%] flex flex-col md:flex-row justify-center items-center text-white gap-[4rem] [&_h3]:text-[120%] [&_h3]:font-[700] [&_p]:font-[500] [&_p]:hover:cursor-pointer transition-all duration-500">
				<div className="w-[100%] xxs:w-[80%] grid grid-cols-1 xxs:grid-cols-2 md:grid-cols-3 gap-[4rem]">
					<div className="">
						...
						<p className="hover:scale-105 duration-200">Categories</p>
