...
const Signup = (props) => {
  ...
  return (
    ...
    >
      <div
        className="w-[80%] md:w-[80%] max-w-[900px] h-[max-content] bg-alab text-black rounded-[80px] overflow-hidden flex flex-col md:flex-row absolute popcon"
      ...
      >
        ...
        <div className="py-10 md:py-[48px] p-[24px] w-full md:w-[55%] flex md:flex-col items-center justify-center">
          <div className="w-full md:w-[80%] h-[80%] flex flex-col items-center justify-center gap-[1rem]">
            ...
            <button
              className="w-[60%] bg-red text-white rounded-[100px] text-[16px] border-none p-[16px] "
