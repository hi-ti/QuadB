...
function ProductCard({
  ...
  return (
    <div className="w-[14.5rem] xxs:w-[13rem] hover:cursor-pointer flex flex-col">
      ...
      >
        <div className="h-[16.5rem] w-[90%] rounded-[100px] relative overflow-hidden object-contain">
          <img
      ...
      <div className="flex justify-center">
        <button
          onClick={handle}
          className="w-[80%] p-2 bg-white text-lion border-[2px] border-black rounded-[100px] font-bold text-[0.8rem] hover:bg-lion hover:text-white hover:border-bone transition-all duration-500"
        >
          {loader ? (
